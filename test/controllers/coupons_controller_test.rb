...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { category: @coupon.category, detail: @coupon.detail, end_date: @coupon.end_date, publisher: @coupon.publisher, start_date: @coupon.start_date } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { category: @coupon.category, detail: @coupon.detail, end_date: @coupon.end_date, publisher: @coupon.publisher, start_date: @coupon.start_date } }
